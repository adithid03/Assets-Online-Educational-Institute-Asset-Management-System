import {TextField,Box,Button,styled,Typography, Radio} from '@mui/material';
            ...
            <Typography style={{textAlign:"center",}}>Login</Typography>
                {
                    account === 'login' ? 
                    <Wrapper>
                            <TextField type ="email" variant="standard" value={login.email} onChange={(e) => onValueChange(e)} name='email' label='Enter Email' />
                ...
                :
                    <Wrapper>
                            ...
                            <Radiob/><Typography>User</Typography>
                            <Radiob/><Typography>Admin</Typography>
                            <TextField variant="standard" onChange={(e) => onInputChange(e)} name='name' label='Enter Name' />
                            <TextField type ="email" variant="standard" onChange={(e) => onInputChange(e)} name='email' label='Enter Email' />
